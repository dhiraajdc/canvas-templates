...
const DUMMY_POOLS = {
  ...
  'market::day_chart': [
    {
      market_name: 'NIFTY 50', close_value: '22,419.95',
      change_pct: '+1.24%', change_pts: '+274.30', direction: 'up',
      high: '22,526', low: '22,198', open: '22,201',
      date: 'May 30, 2026', source: 'NSE India',
      summary: 'IT and banking stocks led broad-based gains as foreign inflows strengthened the rupee.',
      chart_items: [
    ...
    {
      market_name: 'NIFTY 50', close_value: '21,853.80',
      change_pct: '-0.87%', change_pts: '-191.45', direction: 'down',
      high: '22,104', low: '21,790', open: '22,045',
      date: 'May 29, 2026', source: 'NSE India',
      summary: 'Profit booking in heavyweight stocks dragged the index lower in a subdued trading session.',
      chart_items: [
        {label:'9:15',value:62},{label:'10:00',value:55},{label:'11:00',value:48},
        {label:'12:00',value:38},{label:'13:00',value:44},{label:'14:00',value:30},
        {label:'15:00',value:22},{label:'15:30',value:18}
      ],
    },
    {
      market_name: 'SENSEX', close_value: '73,648.62',
      change_pct: '+0.96%', change_pts: '+701.30', direction: 'up',
      high: '73,890', low: '72,988', open: '72,947',
      date: 'May 30, 2026', source: 'BSE India',
      summary: 'Positive global cues and strong FII buying lifted Sensex to a two-week high.',
      chart_items: [
        {label:'9:15',value:22},{label:'10:00',value:38},{label:'11:00',value:35},
        {label:'12:00',value:52},{label:'13:00',value:60},{label:'14:00',value:68},
        {label:'15:00',value:72},{label:'15:30',value:80}
      ],
    },
  ],
  ...
  'news::headline': [
    {
      headline: 'India launches its largest solar power plant in Rajasthan desert',
      summary: 'The 2,400 MW facility is now fully operational, powering over 1.5 million homes and cutting carbon emissions by an estimated 4 million tonnes annually.',
      category: 'Energy',
    ...
    {
      headline: 'Scientists discover new deep-sea species off the coast of Kerala',
      summary: 'Marine biologists from NCPOR identified three previously unknown species during a deep-sea expedition in the Arabian Sea, including a bioluminescent jellyfish.',
      category: 'Science',
      source_name: 'NDTV',
      published: 'May 30, 2026',
    ...
    {
      headline: 'Global meditation app crosses 100 million users milestone',
      summary: 'The mindfulness platform credited its growth to increased awareness around mental health, with India and Southeast Asia emerging as its fastest growing markets.',
      category: 'Wellness',
    ...
    {
      headline: 'WHO report: Workplace stress costs global economy $1 trillion annually',
      summary: 'The World Health Organization calls for urgent action from employers as burnout and anxiety-related absenteeism reach record levels across developed and developing nations.',
      category: 'Health',
      source_name: 'BBC World',
      published: 'May 28, 2026',
      image_url: 'https://picsum.photos/id/15/1080/1350',
      article_url: '',
    },
  ],
