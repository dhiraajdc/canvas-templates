...
## v1.2 — 2026-05-30
**File:** AIFeed_v1.2.html
**Status:** STABLE ✓

### New in v1.2
- Carousel templates: listicle, story_arc, step_by_step, comparison
- Carousel AI content generation (array of slides)
- Carousel edit modal — tabbed UI, per-slide editing
- Pexels API integration — topic-relevant images
- Session image cache — same topic reuses result instantly
- Prefetch images while user types in topic sheet
- Video export — WebCodecs MP4, progress overlay
- Video result page — player, download, Web Share API
- mp4-muxer lazy loaded (saves 25KB on page load)
- Non-blocking Google Fonts loading
- All templates prefetched on page load
- All console.logs removed from production code

### Data files updated
- data/fetchers/image-fetcher.js — new Pexels fetcher
- data/video-exporter.js — WebCodecs + result page
- data/mp4-muxer.min.js — minified (60% smaller)
- data/content-generator.js — parallel image + AI fetch
- data/pipeline.js — carousel array handling
